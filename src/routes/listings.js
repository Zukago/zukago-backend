...
router.get('/', optionalAuth, asyncHandler(async (req, res) => {
  ...
  if (date_start && date_end) {
    try {
      ...
      //    On enrichit avec les bookings driver qui touchent la borne (end == date_start)
      //    car ce jour-là est aussi occupé.
      ...
      const filtered = withRating.filter(l => {
        ...
        // (un hôtel peut avoir 10 chambres dont seulement 2 bookées → toujours dispo)
